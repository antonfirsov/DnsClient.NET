...
namespace DnsClient.Internal
{
    internal static class Polyfill
    {
        ...
        // Task-based Socket.ReceivefromAsync may result in memory leak on .NET Framework.
        // See https://github.com/MichaCo/DnsClient.NET/issues/192
        // To avoid this, we use the old Begin/End pattern on .NET Framework.
